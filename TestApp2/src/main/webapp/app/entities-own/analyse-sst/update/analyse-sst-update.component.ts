...
// import { EnumFive } from '../../enumerations/enum-five.model';
...
/*  calculatecriticite(frequence_var: EnumFive | null | undefined , dureeExposition_var :  EnumFive| null | undefined , coefficientMaitrise_var : EnumFive| null | undefined
    , gravite_var: EnumFive| null | undefined  ) : number { 
   
   return frequence_var  ;
  ...
  onChange(): void{
    ...
    let gra = 1;
    let cri = 1;
    switch(this.editForm.get(['frequence'])!.value) { 
   ...
   switch(this.editForm.get(['dureeExposition'])!.value) { 
    case "ONE": { 
      de = 1;      
       break; 
    } 
 ...
 switch(this.editForm.get(['coefficientMaitrise'])!.value) { 
  case "ONE": { 
    cm = 1;      
     break; 
  } 
...
break; 
 ...
 (<HTMLInputElement>document.getElementById("field_criticite")).value = cri as unknown as string ;
  ...
  save(): void {
    ...
    // analyseSST.criticite = this.calculatecriticite(analyseSST.frequence, analyseSST.dureeExposition, analyseSST.coefficientMaitrise, analyseSST.gravite);
