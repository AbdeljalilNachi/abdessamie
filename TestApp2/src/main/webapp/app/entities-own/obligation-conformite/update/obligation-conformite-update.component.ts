...
let con = 0;
let stat = 0;
switch(this.editForm.get(['applicable'])!.value) { 
  case true: { 
    app = 1;      
     break; 
  } 
...
switch(this.editForm.get(['conforme'])!.value) { 
  case true: { 
    con = 1;      
     break; 
  } 
...
stat = app * con ;
(<HTMLInputElement>document.getElementById("field_statut")).value = stat as unknown as string;
