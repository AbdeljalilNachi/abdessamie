  ...
  describe('PolitiqueQSE Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call ProcessusSMI query and add missing value', () => {
        ...
        const processus: IProcessusSMI = { id: 78155 };
        politiqueQSE.processus = processus;

        const processusSMICollection: IProcessusSMI[] = [{ id: 68651 }];
      ...
      it('Should call IndicateurSMI query and add missing value', () => {
        const politiqueQSE: IPolitiqueQSE = { id: 456 };
        const indicateur: IIndicateurSMI = { id: 68904 };
        politiqueQSE.indicateur = indicateur;

        const indicateurSMICollection: IIndicateurSMI[] = [{ id: 13449 }];
      ...
      it('Should update editForm', () => {
        const politiqueQSE: IPolitiqueQSE = { id: 456 };
        const processus: IProcessusSMI = { id: 7878 };
        politiqueQSE.processus = processus;
        const indicateur: IIndicateurSMI = { id: 12819 };
        politiqueQSE.indicateur = indicateur;
