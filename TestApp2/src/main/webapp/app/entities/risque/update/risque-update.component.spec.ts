  ...
  describe('Risque Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Action query and add missing value', () => {
        ...
        const action: IAction = { id: 86159 };
        risque.action = action;

        const actionCollection: IAction[] = [{ id: 96122 }];
      ...
      it('Should call User query and add missing value', () => {
        const risque: IRisque = { id: 456 };
        const delegue: IUser = { id: 11118 };
        risque.delegue = delegue;

        const userCollection: IUser[] = [{ id: 15712 }];
      ...
      it('Should call ProcessusSMI query and add missing value', () => {
        const risque: IRisque = { id: 456 };
        const processus: IProcessusSMI = { id: 89605 };
        risque.processus = processus;

        const processusSMICollection: IProcessusSMI[] = [{ id: 76110 }];
      ...
      it('Should update editForm', () => {
        const risque: IRisque = { id: 456 };
        const action: IAction = { id: 39443 };
        risque.action = action;
        const delegue: IUser = { id: 30186 };
        risque.delegue = delegue;
        const processus: IProcessusSMI = { id: 16824 };
        risque.processus = processus;
