  ...
  describe('NonConformite Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Action query and add missing value', () => {
        ...
        const action: IAction = { id: 32920 };
        nonConformite.action = action;

        const actionCollection: IAction[] = [{ id: 2948 }];
      ...
      it('Should call User query and add missing value', () => {
        const nonConformite: INonConformite = { id: 456 };
        const delegue: IUser = { id: 34856 };
        nonConformite.delegue = delegue;

        const userCollection: IUser[] = [{ id: 15336 }];
      ...
      it('Should call ProcessusSMI query and add missing value', () => {
        const nonConformite: INonConformite = { id: 456 };
        const processus: IProcessusSMI = { id: 19105 };
        nonConformite.processus = processus;

        const processusSMICollection: IProcessusSMI[] = [{ id: 17225 }];
      ...
      it('Should update editForm', () => {
        const nonConformite: INonConformite = { id: 456 };
        const action: IAction = { id: 11555 };
        nonConformite.action = action;
        const delegue: IUser = { id: 40322 };
        nonConformite.delegue = delegue;
        const processus: IProcessusSMI = { id: 81220 };
        nonConformite.processus = processus;
