...
describe('Component Tests', () => {
  describe('AnalyseSST Management Update Component', () => {
    ...
    let analyseSSTService: AnalyseSSTService;
    ...
    beforeEach(() => {
      ...
      analyseSSTService = TestBed.inject(AnalyseSSTService);
    ...
    describe('ngOnInit', () => {
      it('Should call Action query and add missing value', () => {
        const analyseSST: IAnalyseSST = { id: 456 };
        const action: IAction = { id: 16834 };
        analyseSST.action = action;

        const actionCollection: IAction[] = [{ id: 50047 }];
        ...
        activatedRoute.data = of({ analyseSST });
        comp.ngOnInit();
      ...
      it('Should call User query and add missing value', () => {
        const analyseSST: IAnalyseSST = { id: 456 };
        const delegue: IUser = { id: 13820 };
        analyseSST.delegue = delegue;
      ...
      it('Should call ProcessusSMI query and add missing value', () => {
        const analyseSST: IAnalyseSST = { id: 456 };
        const processus: IProcessusSMI = { id: 84173 };
        analyseSST.processus = processus;

        const processusSMICollection: IProcessusSMI[] = [{ id: 451 }];
      ...
      it('Should update editForm', () => {
        const analyseSST: IAnalyseSST = { id: 456 };
        const action: IAction = { id: 51727 };
        analyseSST.action = action;
        const delegue: IUser = { id: 62330 };
        analyseSST.delegue = delegue;
        const processus: IProcessusSMI = { id: 99546 };
        analyseSST.processus = processus;

        activatedRoute.data = of({ analyseSST });
        comp.ngOnInit();

        expect(comp.editForm.value).toEqual(expect.objectContaining(analyseSST));
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        ...
        const analyseSST = { id: 123 };
        spyOn(analyseSSTService, 'update').and.returnValue(saveSubject);
        ...
        saveSubject.next(new HttpResponse({ body: analyseSST }));
        saveSubject.complete();

        // THEN
        expect(comp.previousState).toHaveBeenCalled();
        expect(analyseSSTService.update).toHaveBeenCalledWith(analyseSST);
      ...
      it('Should call create service on save for new entity', () => {
        // GIVEN
        const saveSubject = new Subject();
        const analyseSST = new AnalyseSST();
        spyOn(analyseSSTService, 'create').and.returnValue(saveSubject);
        spyOn(comp, 'previousState');
        activatedRoute.data = of({ analyseSST });
        comp.ngOnInit();
        ...
        // THEN
        expect(analyseSSTService.create).toHaveBeenCalledWith(analyseSST);
        expect(comp.isSaving).toEqual(false);
        expect(comp.previousState).toHaveBeenCalled();
      });
