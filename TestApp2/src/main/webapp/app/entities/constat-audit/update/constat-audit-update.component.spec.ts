  ...
  describe('ConstatAudit Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Action query and add missing value', () => {
        ...
        const action: IAction = { id: 97742 };
        constatAudit.action = action;

        const actionCollection: IAction[] = [{ id: 78609 }];
      ...
      it('Should call ProcessusSMI query and add missing value', () => {
        const constatAudit: IConstatAudit = { id: 456 };
        const processus: IProcessusSMI = { id: 1525 };
        constatAudit.processus = processus;

        const processusSMICollection: IProcessusSMI[] = [{ id: 38978 }];
      ...
      it('Should call Audit query and add missing value', () => {
        const constatAudit: IConstatAudit = { id: 456 };
        const audit: IAudit = { id: 77046 };
        constatAudit.audit = audit;

        const auditCollection: IAudit[] = [{ id: 71503 }];
      ...
      it('Should update editForm', () => {
        const constatAudit: IConstatAudit = { id: 456 };
        const action: IAction = { id: 13979 };
        constatAudit.action = action;
        const delegue: IUser = { id: 47420 };
        constatAudit.delegue = delegue;
        const processus: IProcessusSMI = { id: 46356 };
        constatAudit.processus = processus;
        const audit: IAudit = { id: 76721 };
        constatAudit.audit = audit;
