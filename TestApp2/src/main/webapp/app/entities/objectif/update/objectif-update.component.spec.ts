  ...
  describe('Objectif Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Action query and add missing value', () => {
        ...
        const action: IAction = { id: 3076 };
        objectif.action = action;

        const actionCollection: IAction[] = [{ id: 20558 }];
      ...
      it('Should call User query and add missing value', () => {
        const objectif: IObjectif = { id: 456 };
        const delegue: IUser = { id: 28146 };
        objectif.delegue = delegue;

        const userCollection: IUser[] = [{ id: 69719 }];
      ...
      it('Should call ProcessusSMI query and add missing value', () => {
        const objectif: IObjectif = { id: 456 };
        const processus: IProcessusSMI = { id: 12885 };
        objectif.processus = processus;

        const processusSMICollection: IProcessusSMI[] = [{ id: 22884 }];
      ...
      it('Should call IndicateurSMI query and add missing value', () => {
        const objectif: IObjectif = { id: 456 };
        const indicateur: IIndicateurSMI = { id: 48885 };
        objectif.indicateur = indicateur;

        const indicateurSMICollection: IIndicateurSMI[] = [{ id: 16544 }];
      ...
      it('Should update editForm', () => {
        const objectif: IObjectif = { id: 456 };
        const action: IAction = { id: 45713 };
        objectif.action = action;
        const delegue: IUser = { id: 58825 };
        objectif.delegue = delegue;
        const processus: IProcessusSMI = { id: 70229 };
        objectif.processus = processus;
        const indicateur: IIndicateurSMI = { id: 15891 };
        objectif.indicateur = indicateur;
