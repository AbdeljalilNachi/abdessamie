  ...
  describe('Reclamation Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Action query and add missing value', () => {
        ...
        const action: IAction = { id: 56726 };
        reclamation.action = action;

        const actionCollection: IAction[] = [{ id: 54832 }];
      ...
      it('Should call User query and add missing value', () => {
        const reclamation: IReclamation = { id: 456 };
        const delegue: IUser = { id: 68804 };
        reclamation.delegue = delegue;

        const userCollection: IUser[] = [{ id: 45631 }];
      ...
      it('Should call ProcessusSMI query and add missing value', () => {
        const reclamation: IReclamation = { id: 456 };
        const processus: IProcessusSMI = { id: 57849 };
        reclamation.processus = processus;

        const processusSMICollection: IProcessusSMI[] = [{ id: 32368 }];
      ...
      it('Should update editForm', () => {
        const reclamation: IReclamation = { id: 456 };
        const action: IAction = { id: 73846 };
        reclamation.action = action;
        const delegue: IUser = { id: 18520 };
        reclamation.delegue = delegue;
        const processus: IProcessusSMI = { id: 64065 };
        reclamation.processus = processus;
